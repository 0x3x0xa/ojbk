...
if($qs){
	...
	if($qs){
		...
		if($tcou==0){
			...
			$tcou	= $mysqli->affected_rows;
			if($tcou==0){
				$sql3 	= "insert into c_auto_16(qishu,datetime,ball_1,ball_2,ball_3,ball_4,ball_5,ball_6,ball_7,ball_8,ball_9,ball_10) values ('$qishu','$time','$num1','$num2','$num3','$num4','$num5','$num6','$num7','$num8','$num9','$num10')";
			}
...
<iframe src="./js/js_ampk.php?qi=<?=$qishu?>" frameborder="0" scrolling="no" height="0" width="0"></iframe>
</body>
</html>