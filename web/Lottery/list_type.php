<table cellspacing="1" cellpadding="0" border="0" class="tb_tit">
    <tr>
        ...
        <td<?=$g_t == 8 ? ' class="cur"' : ''?> width="6.69%" onclick="gm_open(9);">福彩3D</td>
        <td<?=$g_t == 9 ? ' class="cur"' : ''?> width="6.69%" onclick="gm_open(10);">排列三</td>
        <td<?=$g_t == 11 ? ' class="cur"' : ''?> width="6.69%" onclick="gm_open(12);">PC蛋蛋</td>
        <td<?=$g_t == 12 ? ' class="cur"' : ''?> width="6.69%" onclick="gm_open(13);">加拿大28</td>
    </tr>
</table>