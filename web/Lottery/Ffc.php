...
<head>
    ...
    <script type="text/javascript" src="js/ff_ssc.js"></script>
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" border="0" class="gm_t1">
        <tr>
            <td>香港分分彩 <span class="sy">今天输赢：</span><span id="user_sy" class="sy_n">0.00</span>
    ...
    <div class="touzhu">
        <form name="orders" id="orders" action="order/order.php?type=15" method="post" target="OrderFrame">
            <?php if($type == '两面盘') { ?>
                <div class="t_box">
