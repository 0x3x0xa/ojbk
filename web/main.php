...
switch ($type) {
	...
	/*case 15:
		...
		break;*/
	case 15:
		$mainFrame = "Lottery/ffc.php";
		break;
	case 16:
		$mainFrame = "Lottery/ampk.php";
		break;
	case 17:
		$mainFrame = "gsSix/Six_7_1.php";
		break;	
    default:
        $mainFrame = "Lottery/Pk10.php";
}
...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7,IE=9; IE=8; IE=7; IE=EDG"/>
    ...
    <div class="wrp">
		<div class="top">
			...
			<div class="b_box">
				...
				<div class="nav">
					<ul>
						<li<?=$type == 4 ? ' class="cur"' : ''?>><a href="javascript:void(0);" onclick="urlOnclick('Lottery/Pk10.php');" d_num="4">北京赛车</a></li>
						...
						<li class="m_li<?=$type == 2 || $type == 3 || $type == 8 || $type == 9 || $type == 10 || $type == 12 || $type == 13 || $type == 15 || $type == 16 ? ' cur' : ''?>">
							...
							<div class="m_div">
								...
								<a href="javascript:void(0);" onclick="urlOnclick('Lottery/gdsf.php');" d_num="15">广东快乐十分</a>
        ...
        <div class="type">
			...
			<ul<?=$type == 15 ? ' class="on"' : ''?>>
                <li><a href="javascript:void(0);" onclick="urlOnclick('Lottery/ffc.php?t=两面盘');">两面盘</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('Lottery/ffc.php?t=数字盘');">数字盘</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('Lottery/ffc.php?t=第一球');">第一球</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('Lottery/ffc.php?t=第二球');">第二球</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('Lottery/ffc.php?t=第三球');">第三球</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('Lottery/ffc.php?t=第四球');">第四球</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('Lottery/ffc.php?t=第五球');">第五球</a></li>
            </ul>
			<ul<?=$type == 16 ? ' class="on"' : ''?>>
                <li><a href="javascript:void(0);" onclick="urlOnclick('Lottery/ampk.php?t=两面盘');">两面盘</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('Lottery/ampk.php?t=冠,亚军 组合');">冠,亚军 组合</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('Lottery/ampk.php?t=1~10定位');">1~10定位</a></li>
            </ul>
			<ul<?=$type == 17 ? ' class="on"' : ''?>>
                <li><a href="javascript:void(0);" onclick="urlOnclick('gsSix/Six_7_1.php')">特码</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('gsSix/Six_8_3.php')">正码</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('gsSix/Six_1.php')">正码特</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('gsSix/Six_8_2.php')">过关</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('gsSix/Six_9.php')">总和</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('gsSix/Six_10.php')">一肖/尾数</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('gsSix/Six_7_2.php')">波色&特肖</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('gsSix/Six_11.php')">连码</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('gsSix/Six_12.php')">合肖</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('gsSix/Six_13.php')">生肖连</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('gsSix/Six_14.php')">尾数连</a></li>
                <li><a href="javascript:void(0);" onclick="urlOnclick('gsSix/Six_15.php')">全不中</a></li>
            </ul>
        </div>
    </div>
</div>
