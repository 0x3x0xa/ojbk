...
<div class="list-group menucp">
 ...
 <a href="#" class="list-group-item" data-iframe="J_GamesFrame" data-url="Six/Six_7_3.php">香港六合彩<span class="fa fa-lg fa-chevron-right"></span></a>
  <a href="#" class="list-group-item" data-iframe="J_GamesFrame" data-url="gsSix/Six_7_3.php">高速六合彩<span class="fa fa-lg fa-chevron-right"></span></a>
 ...
 <!--  <a href="#" class="list-group-item" data-iframe="J_GamesFrame" data-url="Lottery/Jxssc.php">江西时时彩<span class="fa fa-lg fa-chevron-right"></span></a> -->
 <!--  <a href="#" class="list-group-item" data-iframe="J_GamesFrame" data-url="Lottery/Xjssc.php">新疆时时彩<span class="fa fa-lg fa-chevron-right"></span></a> -->
 <!--    <a href="#" class="list-group-item" data-iframe="J_GamesFrame" data-url="Lottery28/xy28_list.php">PC蛋蛋<span class="fa fa-lg fa-chevron-right"></span></a>
    <a href="#" class="list-group-item" data-iframe="J_GamesFrame" data-url="Lottery28/jnd28_list.php">加拿大28<span class="fa fa-lg fa-chevron-right"></span></a> -->
</div>
