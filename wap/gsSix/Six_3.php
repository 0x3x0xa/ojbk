        ...
        <div class="wrap">
            ...
            <div class="pk s">
                ...
                <select id="gm_type">
                    ...
                    <option value="Six_3.php" selected="selected">正码3</option>
                            ...
                            <li>
                                <div class="wf_box six">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_3_o<?=$s?>"></span>
                                    </div>
                                    <div class="inp" id="ball_3_m<?=$s?>"></div>
                                </div>
                            </li>
                            <?php
                            if($s % 2 == 0 || $s == 49) {
                            ...
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_3_o50"></span>
                                    </div>
                                    <div class="inp" id="ball_3_m50"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_3_o51"></span>
                                    </div>
                                    <div class="inp" id="ball_3_m51"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_3_o52"></span>
                                    </div>
                                    <div class="inp" id="ball_3_m52"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_3_o53"></span>
                                    </div>
                                    <div class="inp" id="ball_3_m53"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_3_o54"></span>
                                    </div>
                                    <div class="inp" id="ball_3_m54"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_3_o55"></span>
                                    </div>
                                    <div class="inp" id="ball_3_m55"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_3_o56"></span>
                                    </div>
                                    <div class="inp" id="ball_3_m56"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_3_o57"></span>
                                    </div>
                                    <div class="inp" id="ball_3_m57"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_3_o58"></span>
                                    </div>
                                    <div class="inp" id="ball_3_m58"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_3_o59"></span>
                                    </div>
                                    <div class="inp" id="ball_3_m59"></div>
                                </div>
                            </li>
                        </ul>
                    </div>
