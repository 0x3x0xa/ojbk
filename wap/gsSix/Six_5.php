        ...
        <div class="wrap">
            ...
            <div class="pk s">
                ...
                <select id="gm_type">
                    ...
                    <option value="Six_5.php" selected="selected">正码5</option>
                            ...
                            <li>
                                <div class="wf_box six">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_5_o<?=$s?>"></span>
                                    </div>
                                    <div class="inp" id="ball_5_m<?=$s?>"></div>
                                </div>
                            </li>
                            <?php
                            if($s % 2 == 0 || $s == 49) {
                            ...
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_5_o50"></span>
                                    </div>
                                    <div class="inp" id="ball_5_m50"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_5_o51"></span>
                                    </div>
                                    <div class="inp" id="ball_5_m51"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_5_o52"></span>
                                    </div>
                                    <div class="inp" id="ball_5_m52"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_5_o53"></span>
                                    </div>
                                    <div class="inp" id="ball_5_m53"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_5_o54"></span>
                                    </div>
                                    <div class="inp" id="ball_5_m54"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_5_o55"></span>
                                    </div>
                                    <div class="inp" id="ball_5_m55"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_5_o56"></span>
                                    </div>
                                    <div class="inp" id="ball_5_m56"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_5_o57"></span>
                                    </div>
                                    <div class="inp" id="ball_5_m57"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_5_o58"></span>
                                    </div>
                                    <div class="inp" id="ball_5_m58"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_5_o59"></span>
                                    </div>
                                    <div class="inp" id="ball_5_m59"></div>
                                </div>
                            </li>
                        </ul>
                    </div>
