                            ...
                            <li>
                                <div class="wf_box six">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_6_o<?=$s?>"></span>
                                    </div>
                                    <div class="inp" id="ball_6_m<?=$s?>"></div>
                                </div>
                            </li>
                            <?php
                            if($s % 2 == 0 || $s == 49) {
                            ...
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_6_o50"></span>
                                    </div>
                                    <div class="inp" id="ball_6_m50"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_6_o51"></span>
                                    </div>
                                    <div class="inp" id="ball_6_m51"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_6_o52"></span>
                                    </div>
                                    <div class="inp" id="ball_6_m52"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_6_o53"></span>
                                    </div>
                                    <div class="inp" id="ball_6_m53"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_6_o54"></span>
                                    </div>
                                    <div class="inp" id="ball_6_m54"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_6_o55"></span>
                                    </div>
                                    <div class="inp" id="ball_6_m55"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_6_o56"></span>
                                    </div>
                                    <div class="inp" id="ball_6_m56"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_6_o57"></span>
                                    </div>
                                    <div class="inp" id="ball_6_m57"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_6_o58"></span>
                                    </div>
                                    <div class="inp" id="ball_6_m58"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_6_o59"></span>
                                    </div>
                                    <div class="inp" id="ball_6_m59"></div>
                                </div>
                            </li>
                        </ul>
                    </div>
