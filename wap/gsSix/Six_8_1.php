    ...
    <div class="container-fluid gm_main">
        ...
        <div class="wrap">
            ...
            <div class="pk s">
                ...
                <select id="gm_type">
                    <option value="Six_8_3.php">正A</option>
                    <option value="Six_8_1.php" selected="selected">正B</option>
                </select>
            </div>
            <div class="tz">
                <form name="orders" id="orders" action="order/order.php?type=0" method="post" target="OrderFrame">
                    <div class="tz_box">
                        <div class="tit">正B</div>
                        <?php
                        for($s = 1; $s <= 49; $s++) {
                            if($s % 2 == 1) {
                                echo '<ul>';
                            ...
                            <li>
                                <div class="wf_box six">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_8_o<?=$s?>"></span>
                                    </div>
                                    <div class="inp" id="ball_8_m<?=$s?>"></div>
                                </div>
                            </li>
                            <?php
                            if($s % 2 == 0 || $s == 49) {
