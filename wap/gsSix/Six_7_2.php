...
$w_name = array('红波','蓝波','绿波','鼠','牛','虎','兔','龙','蛇','马','羊','猴','鸡','狗','猪');
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="wrap">
            ...
            <div class="tz">
                <form name="orders" id="orders" action="order/order.php?type=0" method="post" target="OrderFrame">
                    ...
                    for($s = 62; $s <= 76; $s++) {
                        if($s == 62) {
                            echo '<div class="tz_box"><div class="tit">波色</div>';
                        } elseif($s == 65) {
                            echo '<div class="tz_box"><div class="tit">特肖</div>';
                        }
                        if($s < 65) {
                            if($s % 2 == 0) {
                                echo '<ul>';
                        ...
                        <li>
                            <div class="wf_box">
                                <div class="wf_info">
                                    ...
                                    <span class="qiu"><?=$w_name[$s - 62]?></span>
