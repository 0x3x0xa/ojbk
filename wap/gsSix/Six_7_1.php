    ...
    <div class="container-fluid gm_main">
        ...
        <div class="wrap">
            ...
            <div class="pk s">
                ...
                <select id="gm_type">
                    <option value="Six_7_3.php">特A</option>
                    <option value="Six_7_1.php" selected="selected">特B</option>
                </select>
            </div>
            <div class="tz">
                <form name="orders" id="orders" action="order/order.php?type=0" method="post" target="OrderFrame">
                    <div class="tz_box">
                        <div class="tit">特B</div>
                        <?php
                        for($s = 1; $s <= 49; $s++) {
                            if($s % 2 == 1) {
                                echo '<ul>';
                            ...
                            <li>
                                <div class="wf_box six">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_7_o<?=$s?>"></span>
                                    </div>
                                    <div class="inp" id="ball_7_m<?=$s?>"></div>
                                </div>
                            </li>
                            <?php
                            if($s % 2 == 0 || $s == 49) {
                            ...
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_7_o50"></span>
                                    </div>
                                    <div class="inp" id="ball_7_m50"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_7_o51"></span>
                                    </div>
                                    <div class="inp" id="ball_7_m51"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_7_o52"></span>
                                    </div>
                                    <div class="inp" id="ball_7_m52"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_7_o53"></span>
                                    </div>
                                    <div class="inp" id="ball_7_m53"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_7_o54"></span>
                                    </div>
                                    <div class="inp" id="ball_7_m54"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_7_o55"></span>
                                    </div>
                                    <div class="inp" id="ball_7_m55"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_7_o56"></span>
                                    </div>
                                    <div class="inp" id="ball_7_m56"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_7_o57"></span>
                                    </div>
                                    <div class="inp" id="ball_7_m57"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_7_o58"></span>
                                    </div>
                                    <div class="inp" id="ball_7_m58"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_7_o59"></span>
                                    </div>
                                    <div class="inp" id="ball_7_m59"></div>
                                </div>
                            </li>
                        </ul>
                    </div>
