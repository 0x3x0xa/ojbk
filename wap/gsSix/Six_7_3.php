    ...
    <div class="container-fluid gm_main">
        ...
        <div class="wrap">
            ...
            <div class="pk s">
                ...
                <select id="gm_type">
                    <option value="Six_7_3.php" selected="selected">特A</option>
                    <option value="Six_7_1.php">特B</option>
                </select>
            </div>
            <div class="tz">
                <form name="orders" id="orders" action="order/order.php?type=0" method="post" target="OrderFrame">
                    <div class="tz_box">
                        <div class="tit">特A</div>
                        <?php
                        for($s = 1; $s <= 49; $s++) {
                            if($s % 2 == 1) {
                                echo '<ul>';
                            ...
                            <li>
                                <div class="wf_box six">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_16_o<?=$s?>"></span>
                                    </div>
                                    <div class="inp" id="ball_16_m<?=$s?>"></div>
                                </div>
                            </li>
                            <?php
                            if($s % 2 == 0 || $s == 49) {
                        ...
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        <input class="chk" type="checkbox">
                                        <span class="qiu">特大</span>
                                        <span class="odds" id="ball_16_o50"></span>
                                    </div>
                                    <div class="inp" id="ball_16_m50"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        <input class="chk" type="checkbox">
                                        <span class="qiu">特小</span>
                                        <span class="odds" id="ball_16_o51"></span>
                                    </div>
                                    <div class="inp" id="ball_16_m51"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        <input class="chk" type="checkbox">
                                        <span class="qiu">特单</span>
                                        <span class="odds" id="ball_16_o52"></span>
                                    </div>
                                    <div class="inp" id="ball_16_m52"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        <input class="chk" type="checkbox">
                                        <span class="qiu">特双</span>
                                        <span class="odds" id="ball_16_o53"></span>
                                    </div>
                                    <div class="inp" id="ball_16_m53"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_16_o54"></span>
                                    </div>
                                    <div class="inp" id="ball_16_m54"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_16_o55"></span>
                                    </div>
                                    <div class="inp" id="ball_16_m55"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_16_o56"></span>
                                    </div>
                                    <div class="inp" id="ball_16_m56"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_16_o57"></span>
                                    </div>
                                    <div class="inp" id="ball_16_m57"></div>
                                </div>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_16_o58"></span>
                                    </div>
                                    <div class="inp" id="ball_16_m58"></div>
                                </div>
                            </li>
                            <li>
                                <div class="wf_box">
                                    <div class="wf_info">
                                        ...
                                        <span class="odds" id="ball_16_o59"></span>
                                    </div>
                                    <div class="inp" id="ball_16_m59"></div>
                                </div>
                            </li>
                        </ul>
                    </div>
